...
@section('title', 'Manage Quiz Category')

@section('user',Auth::user()->name)

@section('breadcrumb')
<li class="breadcrumb-item active">Manage Quiz Category</li>
@endsection
@section('css')
  <style>
    .card-btn-right{
    ...
    $('#user_table').DataTable({
            ...
            "columns": [
              ...
              { "data": "quiz_count" },
                {
                  "targets": [ -1 ],
                  "data":"quiz_category_icon", "render": function(data,type,full,meta)
                  {
                     var str = '';
              ...
              {
                  "targets": [ -1 ],
                  "data":"quiz_category_id", "render": function(data,type,full,meta)
                  {
