...
@section('title', 'Quiz Reward Distribution')
...
<li class="breadcrumb-item active">Quiz Reward Distribution</li>
@endsection
    ...
    <div class="card">
        <div class="card-header">
           <div class="row">
                ...
                <div class="col-md-8">
                  <h5 class="m-0">Quiz Reward Distribution</h5>
                </div>
                
            </div>
        </div>  
        <form  action="{{url('/quiz/reward')}}/{{$quiz_id}}" enctype="multipart/form-data" method="POST" id="contest_form" files="true">
