...
@section('title', 'Contest Reward Distribution Edit')
...
<li class="breadcrumb-item active">Contest Reward Distribution Edit</li>
@endsection
    ...
    <div class="card">
        <div class="card-header">
           <div class="row">
                ...
                <div class="col-md-8">
                  <h5 class="m-0">Contest Reward Distribution Edit</h5>
                </div>
                
            </div>
        </div>  
        <form  action="{{url('/contest/reward/update/')}}/{{$contest_id}}" enctype="multipart/form-data" method="POST" id="contest_form" files="true">
